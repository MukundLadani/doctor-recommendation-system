...
# You will need to run the following code once you complete the setup and than comment it
# doctordf = pd.read_csv('doctors.csv')
# for index, row in doctordf.iterrows():
#     data = row.to_dict()  # Convert pandas row to dictionary
